...
export default function UpdateProfileInformation({
  ...
  // avatar ref ini type nya image element
  //<> ini tuh parameter
    ...
    <section className={className}>
      ...
      <form onSubmit={submit} className="mt-6 space-y-6">
        <div className="picture relative">
          ...
          <label
            htmlFor="avatar"
            className="btn btn-primary tabIndex={0} absolute left-1/2 top-6 flex translate-x-5 cursor-pointer items-center justify-center rounded-full px-2"
          >
            <BsCamera />
            <input
              type="file"
